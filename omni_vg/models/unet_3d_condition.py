...
class UNet3DConditionModel(ModelMixin, ConfigMixin, UNet2DConditionLoadersMixin):
    r"""
    A conditional 3D UNet model that takes a noisy sample (video), conditional state, and a timestep and returns a sample
    shaped output.
    ...
    Parameters:
        ...
        mid_block_type (`str`, *optional*, defaults to `"UNetMidBlock3DCrossAttn"`):
            Block type for middle of UNet, it can be one of `UNetMidBlock3DCrossAttn`, `UNetMidBlock3D`.
            If `None`, the mid block layer is skipped.
        ...
        transformer_layers_per_block (`int`, `Tuple[int]`, or `Tuple[Tuple]` , *optional*, defaults to 1):
            ...
            [`~models.unet_3d_blocks.CrossAttnDownBlock3D`], [`~models.unet_3d_blocks.CrossAttnUpBlock3D`],
            [`~models.unet_3d_blocks.UNetMidBlock3DCrossAttn`].
       reverse_transformer_layers_per_block : (`Tuple[Tuple]`, *optional*, defaults to None):
            The number of transformer blocks of type [`~models.attention.BasicTransformerBlock`], in the upsampling
            blocks of the U-Net. Only relevant if `transformer_layers_per_block` is of type `Tuple[Tuple]` and for
            [`~models.unet_3d_blocks.CrossAttnDownBlock3D`], [`~models.unet_3d_blocks.CrossAttnUpBlock3D`],
            [`~models.unet_3d_blocks.UNetMidBloc3DCrossAttn`].
