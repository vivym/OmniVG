...
class AbsolutePositionalEncoding(nn.Module):
    ...
    SCALE_FACTOR = 10000.0  # Scale factor used in the positional encoding computation.

    def __init__(self, dim: int, dropout: float = 0.0, max_length: int = 32):
        super().__init__()
        ...
        div_term = torch.exp(torch.arange(0, dim, 2) * (-math.log(self.SCALE_FACTOR) / dim))
